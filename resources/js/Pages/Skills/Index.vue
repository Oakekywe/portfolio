        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="flex justify-end m-2 p-2">
                    <Link :href="route('skills.create')" type="button"
                    class="px-4 py-2 bg-indigo-500 hover:bg-indigo-700 text-white rounded-md">New Skill</Link>
                </div>
                
                <div class="relative overflow-x-auto">
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 text-gray-500">
                            <tr>
                        ...
                        <tbody>
                            <tr v-for="skill in skills.data" :key="skill.id" class="bg-white border-b ">
                                ...
                                <td class="px-6 py-4">
                                    <img :src="skill.image" class="w-24 h-24 rounded-full">
                                </td>
                                <td class="px-6 py-4">
                                    <Link class="font-medium text-blue-500 hover:text-blue-700 mr-2" 
                                        :href="route('skills.edit', skill.id)"
                                        method=""
                                        as="button" 
                                        type="button"
                                    >Edit</Link>
                                    <Link class="font-medium text-red-500 hover:text-red-700 mr-2" 
